...
class ToyPlugin {
   public:
    ...
    double metabolic_robustness(const std::string& genotype, const std::vector<int>& phen,
                                const std::vector<std::string>& env);
    double regulatory_robustness(const std::string& genotype, const std::vector<int>& logic_vector);
    std::map<std::vector<int>, int> metabolic_evolvability(const std::string& genotype, const std::vector<int>& phen,
                                                           const std::vector<std::string>& env);
    std::map<std::vector<int>, int> regulatory_evolvability(const std::string& genotype,
                                                            const std::vector<int>& logic_vector);
    std::vector<std::pair<int, int>> genotype_str_to_vec(const std::string& genotype) const;
   ...
   private:
    ...
    void init_prot(std::vector<int>& perimeters, std::vector<double>& energies,
                   std::vector<std::vector<double>>& prot_prom_energies, std::vector<std::vector<bool>>& prot_pol);
    void init_dim(std::map<std::pair<int, int>, int>& dim_perim, std::vector<double>& dim_energy,
                  std::vector<std::vector<double>>& dim_prom_energies, std::vector<std::vector<bool>>& dim_pol);
    void init_polymerase(std::vector<double>& polymerase);
    void simplified_mets(std::vector<std::string>& mets, std::map<std::string, int>& not_broken,
                         std::vector<std::string>& env);
    ...
    std::vector<std::pair<int, std::pair<mapa_prot, mapa_dim>>> boolean_network(
    ...
    int metabolism(const std::vector<std::pair<int, int>>& genotype, std::pair<mapa_prot, mapa_dim> objects,
                   mapa_met& met);
    std::vector<int> vec_phenotype(const std::vector<std::pair<int, int>>& genotype,
                                   const std::vector<std::string>& env);
};

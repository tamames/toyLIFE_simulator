...
int INITIAL_FOOD_SIZE = 125;
int SIZE_EACH_FOOD = 8;
float CONTROL = 0.9f;  // The probability of a 1 appearing in the binary string.
int SAMPLE_SIZE = 2;   // the amount of food each individual is going to eat
int FOOD_TO_ADD = 10;  // The amount of food to add each iteration
...
int ENERGY_TO_DIE = 0;
int AGE_TO_DIE =
    50;  // If it's above the number of generations it doesn't matter
float TRANSLATION_ENERGY = 1.0f;
...
int INITIAL_POPULATION_SIZE = 50;

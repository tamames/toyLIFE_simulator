...
int NUMBER_OF_SIMULATION = getNumberOfSimulation(); // Just to to keep track of which simulation we
                                                    // are doing
int ID_COUNT             = 1;

int ENERGY_TO_REPRODUCE  = 25;
int ENERGY_TO_DIE        = 0;
int AGE_TO_DIE           = 500; // If it's above the number of generations it doesn't matter

...
int main() {
    ...
    writeResults(fileName, "The food statistics",
                 {"Max_1s", "Index", "Binary", "Total 1s", "Total 0s", "Total Elements"}, {dataOfFood});
    ...
    writeResults(fileName, "The information of the genotypes at each iteration.",
                 {"Max_1s", "Index", "Binary", "Total 1s", "Total 0s", "Total Elements", "Generation"},
                 dataOfGenotypes);
    ...
    for (int i = 0; i < numberOfGenerations; ++i) {
        ...
        dataOfGeneration.push_back(std::to_string(population.averageEnergyGain[i]));
    ...
    writeResults(fileName, "The population information of the simulation. ",
                 {"Generation", "Average Energy Gain", "Max Energy Gain", "Min Energy Gain"}, dataOfPopulation);
